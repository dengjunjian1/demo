      ...
      <el-tabs v-model="activeName">
        <el-tab-pane label="水站" name="first">
          ...
          <el-table :data="d" border style="width: 1050px">
            ...
            <el-table-column prop="name" label="水站名称" width="200" class="img"></el-table-column>
          ...
          <el-dialog title="添加水站" :visible.sync="dialogFormVisible">
            <el-form>
              <el-form-item label="名称" :label-width="formLabelWidth">
                <el-input v-model="water.name" autocomplete="off"></el-input>
              </el-form-item>
              <el-form-item label="评分" :label-width="formLabelWidth">
                <el-input v-model="water.score" autocomplete="off" type="number"></el-input>
              </el-form-item>
              <el-form-item label="月销售量" :label-width="formLabelWidth">
                <el-input v-model="water.count" autocomplete="off" type="number"></el-input>
              </el-form-item>
              <el-form-item label="点赞数量" :label-width="formLabelWidth">
                <el-input v-model="water.likeNum" autocomplete="off" type="number"></el-input>
              </el-form-item>
              <el-form-item label="浏览量" :label-width="formLabelWidth">
                <el-input v-model="water.readNum" autocomplete="off" type="number"></el-input>
              </el-form-item>
              <el-form-item label="商家地址" :label-width="formLabelWidth">
                <el-input v-model="water.address" autocomplete="off" type="text"></el-input>
              </el-form-item>
              <el-form-item label="距离" :label-width="formLabelWidth">
                <el-input v-model="water.len" autocomplete="off" type="text"></el-input>
              </el-form-item>
              <el-form-item label="商家信息" :label-width="formLabelWidth">
                <el-input v-model="water.des" autocomplete="off" type="text"></el-input>
              </el-form-item>
              <el-form-item label="电话" :label-width="formLabelWidth">
                <el-input v-model="water.tel" autocomplete="off" type="text"></el-input>
              </el-form-item>
              <el-form-item label="价格" :label-width="formLabelWidth">
                <el-input v-model="water.price" autocomplete="off" type="text"></el-input>
              </el-form-item>
              <el-form-item label="图片" :label-width="formLabelWidth">
                <el-input v-model="water.img" autocomplete="off" type="text"></el-input>
              </el-form-item>
            </el-form>
